import { U as reactExports, v as functionalUpdate$1, a as arraysEqual, h as createLRUCache, G as isPromise, H as isRedirect, F as isNotFound, A as invariant, f as createControlledPromise, a0 as rootRouteId, I as isServer$1, d as compileDecodeCharMap, a2 as trimPath, $ as rewriteBasepath, e as composeRewrites, S as processRouteTree, Q as processRouteMasks, _ as resolvePath, c as cleanPath, a4 as trimPathRight, P as parseHref, q as executeRewriteInput, B as isDangerousProtocol, V as redirect, u as findSingleMatch, l as deepEqual, D as DEFAULT_PROTOCOL_ALLOWLIST, b as buildRouteBranch, z as interpolatePath, N as nullReplaceEqualDeep, X as replaceEqualDeep$1, L as last, k as decodePath, s as findFlatMatch, t as findRouteMatch, y as hasKeys, r as executeRewriteOutput, n as encodePathLikeUrl, a3 as trimPathLeft, J as joinPaths, a6 as useRouter, m as dummyMatchContext, M as matchContext, Y as requireReactDom, p as exactPathTest, W as removeTrailingSlash, R as React, K as jsxRuntimeExports, E as isModuleNotFoundError, a5 as useHydrated, o as escapeHtml, C as isInlinableStylesheet, w as getAssetCrossOrigin, Z as resolveManifestAssetLink, O as Outlet } from "./server-G4e4SWkO.js";
import { o as objectType, e as enumType, s as stringType } from "./types-DxrsuSRu.js";
...
const appCss = "/assets/styles-BnD7ABaB.css";
...
function ErrorComponent({ error, reset }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex min-h-screen items-center justify-center bg-background px-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-md text-center", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-2 text-sm text-muted-foreground", children: "Algo deu errado no nosso lado. Você pode tentar recarregar ou voltar ao início." }),
...
const Route$c = createRootRouteWithContext()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Plataforma premium para conteúdo exclusivo privado. Compra anônima, entrega instantânea, total discrição." },
...
const $$splitComponentImporter$b = () => import("./termos-DCLBcqww.js");
const Route$b = createFileRoute("/termos")({
  head: () => ({
    meta: [{
      title: "Termos de Serviço — Meupriv"
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$b, "component")
});
const $$splitComponentImporter$a = () => import("./sobre-G8c82el5.js");
const Route$a = createFileRoute("/sobre")({
  head: () => ({
    meta: [{
      title: "Sobre — Meupriv"
    }, {
      name: "description",
      content: "Como funciona o acesso privado, segurança e discrição na plataforma Meupriv."
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$a, "component")
});
const $$splitComponentImporter$9 = () => import("./reembolso-DriKIXX4.js");
const Route$9 = createFileRoute("/reembolso")({
  head: () => ({
    meta: [{
      title: "Política de Reembolso — Meupriv"
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$9, "component")
});
const $$splitComponentImporter$8 = () => import("./privacidade-D2mRmFEQ.js");
const Route$8 = createFileRoute("/privacidade")({
  head: () => ({
    meta: [{
      title: "Política de Privacidade — Meupriv"
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$8, "component")
});
const $$splitComponentImporter$7 = () => import("./planos-C0da41Ou.js");
const Route$7 = createFileRoute("/planos")({
  head: () => ({
    meta: [{
      title: "Planos — Meupriv"
    }, {
      name: "description",
      content: "Escolha entre três planos exclusivos: Acesso Básico, VIP ou Experiência Privada."
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$7, "component")
});
const $$splitComponentImporter$6 = () => import("./disclaimer-Del78_cj.js");
const Route$6 = createFileRoute("/disclaimer")({
  head: () => ({
    meta: [{
      title: "Disclaimer — Meupriv"
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$6, "component")
});
const $$splitComponentImporter$5 = () => import("./contato-B-glAtns.js");
const Route$5 = createFileRoute("/contato")({
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "Canal privado de suporte."
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$5, "component")
});
const $$splitComponentImporter$4 = () => import("./checkout-COXR5Vbq.js");
const searchSchema = objectType({
  plano: enumType(["basic", "vip", "private"]).optional().default("vip")
});
const Route$4 = createFileRoute("/checkout")({
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "Finalize seu acesso privado de forma segura e anônima."
    }, {
      name: "robots",
      content: "noindex"
    }]
...
const $$splitComponentImporter$3 = () => import("./index-BWNjCZXC.js");
...
const Route$3 = createFileRoute("/")({
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "Plataforma premium para acesso a conteúdo exclusivo privado. Compra anônima, entrega instantânea e total discrição."
    }, {
      property: "og:title",
      content: "Meupriv — Acesso privado e exclusivo"
    }, {
      property: "og:description",
      content: "Conteúdo exclusivo. Compra anônima. Entrega instantânea."
    }]
  }),
...
const $$splitComponentImporter$2 = () => import("./pagamento.sucesso-DER_suwO.js");
const search$1 = objectType({
  plano: enumType(["basic", "vip", "private"]).optional().default("vip")
});
const Route$2 = createFileRoute("/pagamento/sucesso")({
  head: () => ({
    meta: [{
      title: "Acesso liberado — Meupriv"
    }, {
      name: "robots",
      content: "noindex"
    }]
...
const $$splitComponentImporter$1 = () => import("./pagamento.pendente-BZsIkNhJ.js");
const search = objectType({
  plano: stringType().optional()
});
const Route$1 = createFileRoute("/pagamento/pendente")({
  head: () => ({
    meta: [{
      title: "Pagamento pendente — Meupriv"
    }, {
      name: "robots",
      content: "noindex"
    }]
...
const $$splitComponentImporter = () => import("./pagamento.erro-CuCOb8EB.js");
const Route2 = createFileRoute("/pagamento/erro")({
  head: () => ({
    meta: [{
      title: "Erro no pagamento — Meupriv"
    }, {
      name: "robots",
      content: "noindex"
    }]
...
const TermosRoute = Route$b.update({
  id: "/termos",
  path: "/termos",
  getParentRoute: () => Route$c
});
const SobreRoute = Route$a.update({
  id: "/sobre",
  path: "/sobre",
  getParentRoute: () => Route$c
});
const ReembolsoRoute = Route$9.update({
  id: "/reembolso",
  path: "/reembolso",
  getParentRoute: () => Route$c
});
const PrivacidadeRoute = Route$8.update({
  id: "/privacidade",
  path: "/privacidade",
  getParentRoute: () => Route$c
});
const PlanosRoute = Route$7.update({
  id: "/planos",
  path: "/planos",
  getParentRoute: () => Route$c
});
const DisclaimerRoute = Route$6.update({
  id: "/disclaimer",
  path: "/disclaimer",
  getParentRoute: () => Route$c
});
...
const PagamentoSucessoRoute = Route$2.update({
  id: "/pagamento/sucesso",
  path: "/pagamento/sucesso",
  getParentRoute: () => Route$c
});
const PagamentoPendenteRoute = Route$1.update({
  id: "/pagamento/pendente",
  path: "/pagamento/pendente",
  getParentRoute: () => Route$c
});
const PagamentoErroRoute = Route2.update({
  id: "/pagamento/erro",
  path: "/pagamento/erro",
  getParentRoute: () => Route$c
});
